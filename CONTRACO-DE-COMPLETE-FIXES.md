...
**Issue Types:** Wrong Google Analytics ID (2 files), Arrow bullets (3 files)
...
**Change:** Replace `organizational_design_ai` (underscore) with `organizational-design-ai` (hyphens)
...
- [ ] All EN language links use `organizational-design-ai.html` (hyphens)
...
- 3 Link URL fixes (underscores → hyphens)
