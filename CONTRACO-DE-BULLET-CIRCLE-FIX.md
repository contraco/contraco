# CONTRACO.DE: CRITICAL CSS FIXES
## Fix Bullets (Arrows) and Circles (Ellipses) on organizational-design-ai.html

**Status:** 🔴 URGENT - User reported visual issues
**File:** `/home/user/contraco-net/BRAND-UPDATES-INTERNATIONAL/contraco.de/organizational-design-ai.html`
...
## ISSUE 2: Numbered Circles Showing as ELLIPSES (Distorted)

**Current (WRONG):** Lines 316-327
```css
.principle-number {
...
```html
<!-- WRONG -->
<link rel="alternate" hreflang="en" href="https://contraco.net/organizational_design_ai.html">
...
```html
<!-- WRONG -->
<link rel="alternate" hreflang="x-default" href="https://contraco.net/organizational_design_ai.html">
...
```html
<!-- WRONG -->
<a href="https://contraco.net/organizational_design_ai.html" class="lang-link">EN</a>

<!-- CORRECT -->
<a href="https://contraco.net/organizational-design-ai.html" class="lang-link">EN</a>
```

**Change:** Replace ALL instances of `organizational_design_ai` (with underscore) with `organizational-design-ai` (with hyphens)
...
2. **Ellipses:** Missing `flex-shrink: 0` allowed flex containers to squash circles
3. **404 Errors:** Used underscores `organizational_design_ai` instead of hyphens `organizational-design-ai`
